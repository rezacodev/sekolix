...
const tabs = [
  { label: "Articles", href: "/admin/landing-website/posts/articles", icon: FileText },
  { label: "News", href: "/admin/landing-website/posts/news", icon: Newspaper },
  { label: "Events", href: "/admin/landing-website/posts/events", icon: Calendar }
];
...
export default function PostsLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const breadcrumbs: Array<{ label: string; href?: string }> = [
      { label: "Posts", href: "/admin/landing-website/posts/articles" }
    ];
