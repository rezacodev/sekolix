...
export default function StrukturEditor({ pageId }: { pageId: string }) {
  ...
  const handleVicePrincipalChange = (index: number, field: keyof LeadershipItem, value: string) => {
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Kelola data kepala sekolah dan wakil kepala sekolah
            </p>
          </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="hm-name" className="mb-2 block">
                  Nama Lengkap
                </Label>
                <Input
                  id="hm-name"
              ...
              <div>
                <Label htmlFor="hm-email" className="mb-2 block">
                  Email
                </Label>
                <Input
                  id="hm-email"
            ...
            <div>
              <Label htmlFor="hm-phone" className="mb-2 block">
                Telepon
              </Label>
              <Input
                id="hm-phone"
          ...
          <CardContent className="space-y-4">
            {vicePrincipals.length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-8">
                Belum ada wakil kepala sekolah.
              </p>
            ) : (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        id={`vp-name-${index}`}
                        value={vp.name}
                        onChange={e => handleVicePrincipalChange(index, "name", e.target.value)}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        type="email"
                        value={vp.email || ""}
                        onChange={e => handleVicePrincipalChange(index, "email", e.target.value)}
                        placeholder="email@sekolah.sch.id"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        id={`vp-phone-${index}`}
                        value={vp.phone || ""}
                        onChange={e => handleVicePrincipalChange(index, "phone", e.target.value)}
                        placeholder="+62 xxx xxxx xxxx"
                      />
                    </div>
                  </div>
