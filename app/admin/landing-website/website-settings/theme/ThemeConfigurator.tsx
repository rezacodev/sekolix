...
export function ThemeConfigurator({ initialThemes }: { initialThemes: ThemeConfig[] }) {
  ...
  const handleThemeSelect = async (themeId: string) => {
    if (hasUnsavedChanges) {
      setConfirmDialog({
        ...
        description:
          "Anda memiliki perubahan yang belum disimpan. Apakah Anda ingin membatalkannya dan berganti tema?",
  ...
  const handleColorChange = (
    ...
    setThemes(themes.map(t => (t.id === currentTheme.id ? updatedTheme : t)));
  };
  ...
  const handleReset = () => {
    ...
    if (initialState) {
      ...
      // Update in themes array
      setThemes(themes.map(t => (t.id === currentTheme.id ? initialState : t)));
    }
  };
  ...
  const handleResetToDefault = async () => {
    ...
    setConfirmDialog({
      ...
      description:
        "This will reset all colors and fonts to the theme's default values. This action cannot be undone.",
      onConfirm: async () => {
        setIsSaving(true);
        try {
          const response = await fetch("/api/admin/landing-website/theme/reset", {
            method: "POST",
            headers: {
              "Content-Type": "application/json"
            },
          ...
          if (response.ok) {
            ...
            setThemes(
              themes.map(t => (t.id === normalizedResetTheme.id ? normalizedResetTheme : t))
            );
            router.refresh();
            setAlertDialog({
              open: true,
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {theme.themeId === "academic-classic" &&
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  onChange={e => handleColorChange("grayColor", e.target.value)}
                  className="flex-1 cursor-pointer"
                />
              </div>
              <Input
          ...
          <div className="pt-4 border-t">
            <p className="text-sm text-muted-foreground">
              Colors are applied to your website theme. Changes will be visible after saving.
            </p>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm" style={{ fontFamily: currentTheme.bodyFont }}>
                Cepat elang coklat melompati anjing malas. Ini adalah contoh teks isi untuk
                pratinjau font.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <DialogTitle className="text-xl">
                  Pratinjau Tema -{" "}
                  {previewDialog.themeId === "academic-classic"
                    ? "Klasik Akademis"
                    : previewDialog.themeId === "modern-vibrant"
                      ? "Vibran Modern"
                      : "Bersih Minimalis"}
                </DialogTitle>
