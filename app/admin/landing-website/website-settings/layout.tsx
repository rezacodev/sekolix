...
const tabs = [
  { label: "Tema", href: "/admin/landing-website/website-settings/theme", icon: Palette },
  { label: "Bagian Landing", href: "/admin/landing-website/website-settings/landing", icon: Layout }
];
...
export default function WebsiteSettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const breadcrumbs: Array<{ label: string; href?: string }> = [
      { label: "Pengaturan Website", href: "/admin/landing-website/website-settings/theme" }
    ];
