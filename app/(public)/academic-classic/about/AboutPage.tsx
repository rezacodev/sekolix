        ...
        <section className="bg-linear-to-b from-blue-900 to-blue-800 text-white py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-blue-100 max-w-3xl">
              Sekolah kejuruan unggulan dengan fokus pada karakter, keilmuan, dan kesiapan karier. Terakreditasi A dan
              bermitra dengan puluhan industri strategis.
            </p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Menjadi lembaga pendidikan kejuruan terdepan yang menghasilkan lulusan berkarakter, berdaya saing global,
                dan siap berkontribusi pada industri masa depan.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
