            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-6">
                  <div className="flex gap-6 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 mt-2 text-sm">
                        Kepala Sekolah dengan pengalaman lebih dari 20 tahun di bidang pendidikan
                        kejuruan. Berdedikasi untuk meningkatkan standar pendidikan dan memperkuat
                  ...
                  <div className="flex gap-6 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 mt-2 text-sm">
                        Bertanggung jawab atas pengembangan kurikulum yang relevan dengan kebutuhan
                        industri, peningkatan metode pembelajaran, dan sertifikasi kompetensi.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-6 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 mt-2 text-sm">
                        Mengelola pengembangan kesiswaan, disiplin, bimbingan konseling,
                        ekstrakurikuler, dan pembinaan karakter siswa.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-6 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-orange-600 font-semibold">
                        Wakil Kepala Sekolah Bidang Humas & Sarana
                      </p>
                      <p className="text-gray-700 mt-2 text-sm">
                        Menjalin hubungan dengan masyarakat, industri, dan stakeholder. Mengelola
                        sarana prasarana serta fasilitas pendukung pembelajaran.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-linear-to-r from-blue-50 to-orange-50 p-8 rounded-lg border-l-4 border-blue-900">
                ...
                <p className="text-gray-700 mb-4">
                  Komite Sekolah adalah lembaga independen yang berperan dalam pengambilan keputusan
                  strategis, pengawasan, dan evaluasi kinerja sekolah.
                </p>
