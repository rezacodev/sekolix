            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mb-12 bg-white p-8 rounded-lg shadow-sm border border-gray-200">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  SMK Negeri 1 Jakarta menawarkan 4 program keahlian utama yang dirancang mengikuti
                  standar industri terkini. Setiap program dilengkapi dengan fasilitas modern,
                  instruktur bersertifikat, dan kerjasama dengan industri untuk memberikan
                  pengalaman pembelajaran yang aplikatif dan relevan dengan kebutuhan pasar kerja.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Semua program telah terakreditasi dan beberapa telah mendapatkan sertifikasi
                  internasional. Lulusan kami tersebar di berbagai perusahaan terkemuka dan
                  mempunyai tingkat penyerapan kerja di atas 95%.
                </p>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-lg shadow-sm border-t-4 border-blue-900 overflow-hidden">
                  <div className="bg-linear-to-r from-blue-900 to-blue-800 p-6 text-white">
                    ...
                    <p className="text-blue-100 mt-2">
                      Menghasilkan teknisi otomotif profesional dan siap bersaing global
                    </p>
                  </div>
                  <div className="p-6">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <p className="text-sm text-gray-600">
                        <strong>Durasi:</strong> 3 tahun | <strong>Kapasitas:</strong> 3 rombel (120
                        siswa) |<strong> Instruktur:</strong> 8 orang bersertifikat internasional
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border-t-4 border-orange-500 overflow-hidden">
                  <div className="bg-linear-to-r from-orange-600 to-orange-500 p-6 text-white">
                    ...
                    <p className="text-orange-100 mt-2">
                      Mempersiapkan teknisi listrik yang kompeten dan inovatif
                    </p>
                  </div>
                  <div className="p-6">
                    <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <p className="text-sm text-gray-600">
                        <strong>Durasi:</strong> 3 tahun | <strong>Kapasitas:</strong> 3 rombel (120
                        siswa) |<strong> Instruktur:</strong> 10 orang bersertifikat
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border-t-4 border-blue-900 overflow-hidden">
                  <div className="bg-linear-to-r from-blue-800 to-blue-700 p-6 text-white">
                    ...
                    <p className="text-blue-100 mt-2">
                      Mengembangkan teknisi permesinan dengan presisi tinggi
                    </p>
                  </div>
                  <div className="p-6">
                    <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <p className="text-sm text-gray-600">
                        <strong>Durasi:</strong> 3 tahun | <strong>Kapasitas:</strong> 2 rombel (80
                        siswa) |<strong> Instruktur:</strong> 6 orang bersertifikat
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border-t-4 border-orange-500 overflow-hidden">
                  <div className="bg-linear-to-r from-orange-700 to-orange-600 p-6 text-white">
                    ...
                    <p className="text-orange-100 mt-2">
                      Melatih teknisi elektronika modern dengan teknologi terkini
                    </p>
                  </div>
                  <div className="p-6">
                    <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <p className="text-sm text-gray-600">
                        <strong>Durasi:</strong> 3 tahun | <strong>Kapasitas:</strong> 2 rombel (80
                        siswa) |<strong> Instruktur:</strong> 7 orang bersertifikat
                      </p>
                    </div>
                  </div>
                </div>
