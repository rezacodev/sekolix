                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 mb-4">
                        Fasilitas lengkap untuk pembelajaran teknik otomotif dengan peralatan
                        diagnostik modern dan bengkel standar industri.
                      </p>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 mb-4">
                        Lab listrik dengan instalasi panel listrik bertegangan tinggi dan peralatan
                        uji standar nasional dan internasional.
                      </p>
                      <ul className="text-sm text-gray-600 space-y-1">
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 mb-4">
                        Ruang permesinan dengan mesin CNC dan konvensional untuk melatih kemampuan
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 mb-4">
                        Lab elektronika dilengkapi dengan peralatan testing canggih untuk praktik
                        troubleshooting dan design sirkuit elektronik.
                      </p>
                      <ul className="text-sm text-gray-600 space-y-1">
              ...
              <div className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-blue-900 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700">
                        Semua ruang kelas dilengkapi dengan AC, proyektor, smart board interaktif,
                        dan koneksi internet berkecepatan tinggi untuk pembelajaran digital.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-blue-900 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-blue-900 mb-3">
                        Perpustakaan & Learning Center
                      </h3>
                      <p className="text-gray-700">
                        Koleksi buku 10.000+ judul, majalah teknis, jurnal, akses e-library, dan
                        ruang belajar kelompok dengan WiFi penuh.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-blue-900 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700">
                        3 lab dengan 150+ unit komputer, dilengkapi software profesional, CAD,
                        simulation tools, dan sistem keamanan berlapis.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-blue-900 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-blue-900 mb-3">
                        Ruang Multimedia & Design
                      </h3>
                      <p className="text-gray-700">
                        Studio untuk media pembelajaran, video production, desain grafis dengan
                        peralatan profesional dan iklim kontrol.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-blue-900 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700">
                        Aula & ruang seminar dengan kapasitas hingga 500 orang, sistem audiovisual
                        canggih untuk acara akademik & non-akademik.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-blue-900 hover:shadow-lg transition-shadow">
                    <div className="relative h-48 w-full">
                      <Image
                        src="https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=500&h=300&fit=crop"
                        alt="Asrama Siswa"
                        fill
                        className="object-cover"
                      />
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700">
                        Asrama berstandar internasional untuk siswa luar daerah dengan fasilitas
                        keamanan, penunjang akademik, dan rekreasi.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-b-4 border-orange-500 hover:shadow-lg transition-shadow">
                    <div className="relative h-48 w-full">
                      <Image
                        src="https://images.unsplash.com/photo-1546519638-68711109d298?w=500&h=300&fit=crop"
                        alt="Lapangan Basket"
                        fill
                        className="object-cover"
                      />
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-sm text-gray-700">
                        Indoor & outdoor dengan fasilitas lighting profesional
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-b-4 border-orange-500 hover:shadow-lg transition-shadow">
                    <div className="relative h-48 w-full">
                      <Image
                        src="https://images.unsplash.com/photo-1517457373614-b7152f800fd1?w=500&h=300&fit=crop"
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-sm text-gray-700">
                        Lapangan standar dengan rumput sintetis & drainage modern
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-b-4 border-orange-500 hover:shadow-lg transition-shadow">
                    <div className="relative h-48 w-full">
                      <Image
                        src="https://images.unsplash.com/photo-1503465463093-ac5ff5688c07?w=500&h=300&fit=crop"
                        alt="Lapangan Voli"
                        fill
                        className="object-cover"
                      />
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-sm text-gray-700">
                        3 lapangan indoor dengan sistem pencahayaan berstandar kompetisi
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-b-4 border-orange-500 hover:shadow-lg transition-shadow">
                    <div className="relative h-48 w-full">
                      <Image
                        src="https://images.unsplash.com/photo-1576610616656-d3aa5d1f4534?w=500&h=300&fit=crop"
                        alt="Kolam Renang"
                        fill
                        className="object-cover"
                      />
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-sm text-gray-700">
                        Kolam Olympic-size dengan sistem filtrasi modern
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-b-4 border-orange-500 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-sm text-gray-700">
                        Equipment modern dengan pelatih profesional bersertifikat
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-b-4 border-orange-500 hover:shadow-lg transition-shadow">
                    <div className="relative h-48 w-full">
                      <Image
                        src="https://images.unsplash.com/photo-1577720643272-265f434b8bc0?w=500&h=300&fit=crop"
                        alt="Ruang Seni"
                        fill
                        className="object-cover"
                      />
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-sm text-gray-700">
                        Studio seni, musik, dan tari dengan peralatan profesional
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    <div className="relative h-48 w-full">
                      <Image
                        src="https://images.unsplash.com/photo-1576091160550-112accb0c0f5?w=500&h=300&fit=crop"
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 text-sm">
                        Layanan kesehatan 24/7 dengan dokter dan perawat, pemeriksaan kesehatan
                        berkala, dan farmasi lengkap.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    <div className="relative h-48 w-full">
                      <Image
                        src="https://images.unsplash.com/photo-1564834744159-c0d6b5f66e23?w=500&h=300&fit=crop"
                        alt="Kantin"
                        fill
                        className="object-cover"
                      />
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 text-sm">
                        Kantin bersih bersertifikat dengan menu bergizi, halal, dan terjangkau untuk
                        semua kalangan.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 text-sm">
                        Bus sekolah dengan rute mencakup seluruh wilayah Jakarta untuk kemudahan
                        akses siswa.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    <div className="relative h-48 w-full">
                      <Image
                        src="https://images.unsplash.com/photo-1549148328-7f4d8f7d7d5a?w=500&h=300&fit=crop"
                        alt="Keamanan"
                        fill
                        className="object-cover"
                      />
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 text-sm">
                        Sistem keamanan berlapis dengan CCTV, security gate, dan tim keamanan
                        profesional 24 jam.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 text-sm">
                        Server, cloud system, WiFi coverage 100%, backup system, dan cybersecurity
                        terdepan.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm overflow-hidden border-t-4 border-orange-500 hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 text-sm">
                        Fasilitas ramah difabel dengan ramp, lift, toilet khusus, dan dukungan
                        pendampingan siswa.
                      </p>
                    </div>
                  </div>
