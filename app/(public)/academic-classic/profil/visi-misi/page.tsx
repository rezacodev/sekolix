...
export const metadata = {
  ...
  description:
    "Visi, misi, dan nilai-nilai inti SMK Negeri 1 Jakarta dalam membentuk generasi muda berkualitas"
};
              ...
              <div className="mb-16">
                ...
                <div className="bg-linear-to-r from-blue-50 to-orange-50 border-l-4 border-blue-900 p-8 rounded-r-lg">
                  <p className="text-xl text-gray-800 leading-relaxed font-semibold">
                    &ldquo;Menjadi lembaga pendidikan kejuruan terdepan yang menghasilkan sumber
                    daya manusia berkualitas tinggi, berkarakter luhur, berdaya saing global, dan
                    siap berkontribusi pada pembangunan bangsa.&rdquo;
                  </p>
                </div>
                <div className="mt-6 bg-white p-6 rounded-lg border border-gray-200">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex gap-3">
                      ...
                      <span>
                        <strong>Terdepan:</strong> Memimpin dalam inovasi pendidikan dan
                    ...
                    <li className="flex gap-3">
                      <span className="text-blue-900 font-bold">•</span>
                      <span>
                        <strong>Berkualitas Tinggi:</strong> Standar pendidikan yang selalu
                        meningkat dan memenuhi atau melampaui ekspektasi stakeholder
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-blue-900 font-bold">•</span>
                      <span>
                        <strong>Berkarakter Luhur:</strong> Lulusan yang tidak hanya terampil teknis
                    ...
                    <li className="flex gap-3">
                      <span className="text-blue-900 font-bold">•</span>
                      <span>
                        <strong>Daya Saing Global:</strong> Mampu bersaing di pasar kerja
                        internasional dengan sertifikasi dan kompetensi yang diakui dunia
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Memberikan pembelajaran yang relevan dengan kebutuhan industri,
                          menggunakan metode pedagogi modern, dan mengintegrasikan teori dengan
                          praktik real-world.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-white border-l-4 border-orange-500 p-6 rounded-r-lg shadow-sm">
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Memfasilitasi pengembangan hard skills (teknis) dan soft skills
                          (komunikasi, leadership, problem-solving) untuk menghadapi tantangan dunia
                          kerja modern.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-white border-l-4 border-orange-500 p-6 rounded-r-lg shadow-sm">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-blue-900 mb-2">
                          Membina karakter dan nilai-nilai kearifan lokal
                        </h3>
                        <p className="text-gray-700">
                          Membangun siswa yang tidak hanya kompeten tetapi juga berakhlak mulia,
                          menghargai budaya lokal, dan berkontribusi pada kehidupan bermasyarakat.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white border-l-4 border-orange-500 p-6 rounded-r-lg shadow-sm">
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Menciptakan ekosistem pembelajaran yang melibatkan dunia usaha, lembaga
                          sertifikasi, dan universitas untuk meningkatkan relevansi dan karir siswa.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white border-l-4 border-orange-500 p-6 rounded-r-lg shadow-sm">
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Memfasilitasi siswa untuk menjadi innovators dan entrepreneurs, membuka
                          peluang untuk menciptakan lapangan kerja dan berkontribusi pada
                          pertumbuhan ekonomi.
                        </p>
                      </div>
                    </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-linear-to-br from-blue-900 to-blue-700 text-white p-8 rounded-lg">
                    ...
                    <p>
                      Berkomitmen pada kejujuran, transparansi, dan konsistensi dalam setiap
                  ...
                  <div className="bg-linear-to-br from-orange-500 to-orange-600 text-white p-8 rounded-lg">
                    ...
                    <p>
                      Selalu berusaha memberikan yang terbaik, mencapai standar tertinggi, dan terus
                  ...
                  <div className="bg-linear-to-br from-blue-800 to-blue-600 text-white p-8 rounded-lg">
                    ...
                    <p>
                      Terbuka terhadap ide baru, mendorong kreativitas, dan terus mengembangkan
                  ...
                  <div className="bg-linear-to-br from-orange-600 to-orange-700 text-white p-8 rounded-lg">
                    ...
                    <p>
                      Bekerja sama secara efektif, menghargai keberagaman, dan menciptakan
                      lingkungan yang inklusif dan saling mendukung.
                    </p>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-blue-700 to-blue-500 text-white p-8 rounded-lg">
                    ...
                    <p>
                      Bertanggung jawab terhadap lingkungan, masyarakat, dan generasi mendatang
                      dalam setiap program dan keputusan.
                    </p>
                  </div>
                  ...
                  <div className="bg-linear-to-br from-orange-700 to-orange-800 text-white p-8 rounded-lg">
                    ...
                    <p>
                      Tetap merendah, siap belajar, dan mendengarkan masukan untuk terus berkembang
