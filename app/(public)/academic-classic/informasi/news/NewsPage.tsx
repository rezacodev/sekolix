          ...
          <header className="bg-linear-to-b from-blue-900 to-blue-800 text-white py-14">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <p className="text-blue-100 mt-3">
                Update terbaru seputar kegiatan, prestasi, dan informasi sekolah.
              </p>
            </div>
          </header>
          ...
          <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {newsList.map(item => (
                ...
                >
                  <div className="text-xs uppercase tracking-wide text-blue-800 font-semibold mb-2">
                    {item.category}
                  </div>
            ...
            <div className="mt-10 flex items-center justify-between text-sm text-gray-600">
              ...
              <div className="flex gap-2">
                <button
                  className="px-3 py-1 border border-gray-300 rounded bg-white text-gray-400 cursor-not-allowed"
                  disabled
                >
                  Sebelumnya
                </button>
