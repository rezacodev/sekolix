...
export const metadata = {
  ...
  description: "Fasilitas lengkap dan modern untuk mendukung pembelajaran berkualitas di SMK Negeri 1 Jakarta",
};
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow border-t-4 border-linear-to-r from-cyan-500 to-purple-500">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-800 mb-3">Laboratorium Mekatronika</h3>
                  <ul className="text-sm text-gray-600 space-y-2">
            ...
            {/* Fasilitas Penunjang */}
            <div className="mb-16">
              <h2 className="text-2xl font-bold text-center mb-8 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Fasilitas Penunjang</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-linear-to-br from-cyan-50 to-purple-50 p-6 rounded-lg border border-cyan-200">
                  ...
                  <p className="text-sm text-gray-600">Koleksi 5000+ buku dan jurnal digital dengan akses 24/7</p>
                </div>
                ...
                <div className="bg-linear-to-br from-cyan-50 to-purple-50 p-6 rounded-lg border border-purple-200">
                  ...
                  <p className="text-sm text-gray-600">Fasilitas olahraga lengkap dengan basketball court dan volleyball</p>
                </div>
                ...
                <div className="bg-linear-to-br from-cyan-50 to-purple-50 p-6 rounded-lg border border-cyan-200">
                  ...
                  <p className="text-sm text-gray-600">Kapasitas 1000 orang untuk acara seminar dan konferensi</p>
                </div>
                ...
                <div className="bg-linear-to-br from-cyan-50 to-purple-50 p-6 rounded-lg border border-purple-200">
                  ...
                  <p className="text-sm text-gray-600">Makanan sehat dan bergizi dengan harga terjangkau</p>
                </div>
                ...
                <div className="bg-linear-to-br from-cyan-50 to-purple-50 p-6 rounded-lg border border-cyan-200">
                  ...
                  <p className="text-sm text-gray-600">Layanan kesehatan 24 jam dengan tenaga medis profesional</p>
                </div>
                ...
                <div className="bg-linear-to-br from-cyan-50 to-purple-50 p-6 rounded-lg border border-purple-200">
                  ...
                  <p className="text-sm text-gray-600">Akomodasi nyaman untuk siswa dari luar kota</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-8 border-2 border-cyan-200 mb-16">
              <h2 className="text-2xl font-bold text-center mb-8 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Teknologi dan Konektivitas</h2>
            ...
            <div className="bg-linear-to-r from-cyan-50 to-purple-50 rounded-lg p-8 text-center border border-cyan-200">
              ...
              <p className="text-gray-600 mb-6">Semua fasilitas kami memenuhi standar internasional dan regulasi pemerintah</p>
