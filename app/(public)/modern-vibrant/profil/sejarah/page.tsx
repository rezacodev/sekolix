    ...
    >
      <div className="w-full">
            ...
            <div className="space-y-12">
              ...
              <div className="flex gap-8">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold">1985</div>
                  <div className="w-1 h-32 bg-linear-to-b from-cyan-300 to-purple-300 mt-4"></div>
                </div>
                <div className="pb-8">
                  <h3 className="text-2xl font-bold bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent mb-2">Pendirian Sekolah</h3>
              ...
              <div className="flex gap-8">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold">1990</div>
                  <div className="w-1 h-32 bg-linear-to-b from-cyan-300 to-purple-300 mt-4"></div>
                </div>
                <div className="pb-8">
                  <h3 className="text-2xl font-bold bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent mb-2">Ekspansi Program</h3>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <div className="flex gap-8">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold">2000</div>
                  <div className="w-1 h-32 bg-linear-to-b from-cyan-300 to-purple-300 mt-4"></div>
                </div>
                <div className="pb-8">
                  <h3 className="text-2xl font-bold bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent mb-2">Sertifikasi Internasional</h3>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <div className="flex gap-8">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold">2010</div>
                  <div className="w-1 h-32 bg-linear-to-b from-cyan-300 to-purple-300 mt-4"></div>
                </div>
                <div className="pb-8">
                  <h3 className="text-2xl font-bold bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent mb-2">Transformasi Digital</h3>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <div className="flex gap-8">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold">2025</div>
                </div>
                <div className="pb-8">
                  <h3 className="text-2xl font-bold bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent mb-2">Era Inovasi Berkelanjutan</h3>
                  <p className="text-gray-700 leading-relaxed">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Pencapaian Utama</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-6 border-l-4 border-linear-to-b from-cyan-500 to-purple-500 rounded-lg shadow-sm">
