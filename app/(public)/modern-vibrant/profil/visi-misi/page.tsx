          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-16">
              <div className="flex items-start gap-6 mb-8">
                ...
                <div>
                  <h2 className="text-3xl font-bold mb-4 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Visi</h2>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h2 className="text-3xl font-bold mb-4 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Misi</h2>
                  <div className="space-y-4">
                    <div className="bg-linear-to-r from-cyan-50 to-purple-50 p-6 rounded-lg border border-cyan-200">
                      <h3 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                        <span className="shrink-0 w-6 h-6 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white text-sm">1</span>
                    ...
                    <div className="bg-linear-to-r from-cyan-50 to-purple-50 p-6 rounded-lg border border-cyan-200">
                      <h3 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                        <span className="shrink-0 w-6 h-6 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white text-sm">2</span>
                    ...
                    <div className="bg-linear-to-r from-cyan-50 to-purple-50 p-6 rounded-lg border border-cyan-200">
                      <h3 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                        <span className="shrink-0 w-6 h-6 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white text-sm">3</span>
                        Pembinaan Karakter
                      </h3>
                    ...
                    <div className="bg-linear-to-r from-cyan-50 to-purple-50 p-6 rounded-lg border border-cyan-200">
                      <h3 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                        <span className="shrink-0 w-6 h-6 bg-linear-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white text-sm">4</span>
                        Kemitraan Strategis
                      </h3>
            ...
            {/* Values Section */}
            <div className="mt-20">
              <h2 className="text-3xl font-bold text-center mb-12 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Nilai-Nilai Inti</h2>
