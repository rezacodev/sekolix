          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-center mb-12">
              <div className="w-64 bg-linear-to-br from-cyan-500 to-purple-500 rounded-lg p-8 text-white text-center shadow-lg">
                ...
                <p className="text-xs text-cyan-100">Kepemimpinan visioner untuk masa depan pendidikan</p>
              </div>
            </div>

            {/* Wakil Kepala Sekolah */}
            <div className="mb-16">
              <h2 className="text-2xl font-bold text-center mb-8 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Wakil Kepala Sekolah</h2>
            ...
            {/* Kepala Departemen */}
            <div className="mb-16">
              <h2 className="text-2xl font-bold text-center mb-8 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Kepala Departemen Program Keahlian</h2>
              <div className="space-y-6">
                {[
                  ...
                  <div key={idx} className="bg-linear-to-r from-cyan-50 to-purple-50 border-l-4 border-cyan-500 rounded-lg p-6">
            ...
            <div className="bg-white rounded-lg p-8 border-2 border-cyan-200">
              <h2 className="text-2xl font-bold text-center mb-6 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Tim Pendidik dan Tenaga Kependidikan</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center p-6 bg-linear-to-br from-cyan-50 to-purple-100 rounded-lg">
                  <div className="text-5xl font-bold bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent mb-2">3000+</div>
