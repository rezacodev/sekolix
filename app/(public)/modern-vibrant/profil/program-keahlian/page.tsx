...
export const metadata = {
  ...
  description: "Program keahlian unggulan yang ditawarkan SMK Negeri 1 Jakarta dengan kurikulum relevan industri",
};
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-center text-gray-600 mb-16 text-lg">
              SMK Negeri 1 Jakarta menawarkan 4 program keahlian dengan kurikulum modern yang dirancang bekerja sama dengan industri terkemuka
            </p>
            ...
            <div className="mb-12 bg-white rounded-lg shadow-lg border-l-4 border-gradient-to-b from-cyan-500 to-purple-500 overflow-hidden">
              <div className="bg-linear-to-r from-cyan-100 to-purple-100 p-8">
                ...
                <p className="text-gray-600">Perpaduan sempurna mekanik, elektronik, dan pemrograman untuk era industri modern</p>
              </div>
              <div className="p-8">
                ...
                <div className="mt-6 p-4 bg-cyan-50 rounded-lg border border-cyan-200">
                  <p className="text-sm text-gray-700"><span className="font-bold">Durasi:</span> 3 Tahun | <span className="font-bold">Intake:</span> 4 Rombel</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 bg-white rounded-lg shadow-lg border-l-4 border-gradient-to-b from-cyan-500 to-purple-500 overflow-hidden">
              <div className="bg-linear-to-r from-cyan-100 to-purple-100 p-8">
                ...
                <p className="text-gray-600">Mengembangkan solusi digital dan teknologi informasi untuk transformasi bisnis</p>
              </div>
              <div className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
            ...
            <div className="mb-12 bg-white rounded-lg shadow-lg border-l-4 border-gradient-to-b from-cyan-500 to-purple-500 overflow-hidden">
              <div className="bg-linear-to-r from-cyan-100 to-purple-100 p-8">
                ...
                <p className="text-gray-600">Mengasah keahlian instalasi, operasi, dan maintenance sistem kelistrikan modern</p>
              </div>
              <div className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                ...
                <div className="mt-6 p-4 bg-cyan-50 rounded-lg border border-cyan-200">
                  <p className="text-sm text-gray-700"><span className="font-bold">Durasi:</span> 3 Tahun | <span className="font-bold">Intake:</span> 3 Rombel</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 bg-white rounded-lg shadow-lg border-l-4 border-gradient-to-b from-cyan-500 to-purple-500 overflow-hidden">
              <div className="bg-linear-to-r from-cyan-100 to-purple-100 p-8">
                ...
                <p className="text-gray-600">Pelatihan praktis dalam perawatan, perbaikan, dan diagnosis kendaraan modern</p>
              </div>
              <div className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
            ...
            <div className="bg-white rounded-lg p-8 border-2 border-cyan-200">
              <h2 className="text-2xl font-bold text-center mb-8 bg-linear-to-r from-cyan-600 to-purple-600 bg-clip-text text-transparent">Keunggulan Program Kami</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Dirancang bekerja sama langsung dengan perusahaan besar</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Kesempatan internship di perusahaan ternama</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Guru dari praktisi industri dengan pengalaman luas</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Laboratorium dan workshop dengan peralatan terkini</p>
                  </div>
                </div>
              </div>
            </div>
