...
export default async function ModernVibrantPage() {
  ...
  const heroData = {
    ...
    imageUrl: heroSection?.image ?? 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1920&h=1080&fit=crop',
    videoUrl: undefined,
  ...
  const carouselItems = [
    {
      ...
      description: 'Our students showcased groundbreaking projects in robotics, AI, and environmental science. The event attracted visitors from across the region.',
    ...
    },
    {
      ...
      description: 'Students from 25 countries came together to celebrate diversity through music, dance, and traditional cuisines.',
    ...
    },
    {
      ...
      description: 'Our basketball team clinched the regional championship title after an intense finals match. Proud of our champions!',
  ...
  const cardsData = [
    {
      ...
      description: 'State-of-the-art facilities with 3D printers, robotics kits, and VR equipment now available for all students.',
    ...
    },
    {
      ...
      description: 'Applications now open for our international exchange program with partner schools in 15 countries.',
    ...
    },
    {
      ...
      description: 'Our students&apos; artwork was featured in the city gallery, receiving praise from local art critics.',
    ...
    },
    {
      ...
      description: 'Free weekend coding workshops for beginners. Learn Python, JavaScript, and web development basics.',
    ...
    },
    {
      ...
      description: 'Students launch campus-wide sustainability project, planting 500 trees and installing solar panels.',
    ...
    },
    {
      ...
      description: 'Representatives from 50+ universities will be on campus to discuss admission opportunities.',
  ...
  const testimonialsData = [
    {
      ...
      quote: "Sekolah ini memberikan fondasi yang sangat kuat untuk karir saya di dunia IT. Guru-gurunya luar biasa dan fasilitasnya sangat modern!",
      rating: 5,
    },
    {
      id: 2,
      ...
      quote: "Belajar di sini sangat menyenangkan! Banyak kegiatan ekstrakurikuler dan program magang yang mempersiapkan kami untuk dunia kerja.",
      rating: 5,
    },
    {
      id: 3,
      ...
      quote: "Setelah lulus, saya langsung diterima kerja di perusahaan startup ternama. Skill yang saya dapat di sekolah ini sangat applicable!",
      rating: 5,
    },
  ];
  ...
  const newsData = [
    ...
    },
    {
      ...
      excerpt: "Pendaftaran siswa baru telah dibuka! Dapatkan early bird discount hingga 20% untuk pendaftar 100 siswa pertama.",
