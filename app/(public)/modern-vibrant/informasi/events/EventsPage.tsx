...
const sampleEvents = [
  {
    ...
    description: '40+ perusahaan teknologi membuka peluang magang dan kerja untuk siswa tingkat akhir.',
  },
  {
    title: 'Design Sprint Week',
    date: '2026-02-02',
    location: 'Innovation Lab',
    description: 'Sprint 5 hari untuk membangun prototipe produk digital dengan mentor UX dan startup founder.',
  },
  {
        ...
        <main className="pt-20">
          <section className="bg-linear-to-r from-cyan-500 to-purple-500 text-white py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <p className="text-lg text-cyan-100">Kegiatan terkini seputar inovasi, karier, dan kolaborasi industri</p>
            </div>
          </section>

          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 grid grid-cols-1 md:grid-cols-2 gap-6">
            {sampleEvents.map((event) => (
              <div key={event.title} className="bg-slate-800/60 border border-white/10 rounded-2xl p-6 hover:border-cyan-400/60 transition">
                <div className="text-xs uppercase tracking-[0.2em] text-cyan-300 mb-2">{formatDate(event.date)}</div>
