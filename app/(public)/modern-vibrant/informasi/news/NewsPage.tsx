        ...
        <main className="pt-20">
          <section className="bg-linear-to-r from-cyan-500 to-purple-500 text-white py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <p className="text-lg text-cyan-100">Sorotan inovasi, kolaborasi industri, dan prestasi terbaru siswa</p>
            </div>
          </section>
            ...
            {newsList.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
                {newsList.map((item) => (
                  ...
                  >
                    <div className="text-xs uppercase tracking-[0.2em] text-cyan-300 mb-2">{item.publishedAt}</div>
                    <h3 className="text-xl font-semibold mb-2 group-hover:text-cyan-200">{item.title}</h3>
