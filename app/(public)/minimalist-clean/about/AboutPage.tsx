        ...
        <main className="pt-24">
          ...
          <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
            <div className="grid md:grid-cols-3 gap-8 border-t border-slate-200 pt-12">
              {[
                { title: 'Fokus Industri', desc: 'Pembelajaran berbasis proyek dengan mentor praktisi.' },
                { title: 'Laboratorium', desc: 'Peralatan terkini untuk otomasi, desain, dan komputasi.' },
                { title: 'Karier & Kampus', desc: 'Bimbingan karier, beasiswa, dan jalur kuliah lanjut.' },
              ].map((item) => (
