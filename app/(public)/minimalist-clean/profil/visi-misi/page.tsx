        ...
        <main className="min-h-screen bg-white overflow-x-hidden w-full pt-20">
          ...
          <div className="text-center bg-gray-50 py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Visi & Misi</h1>
                    ...
                    <div className="space-y-4">
                      <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                        <h3 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                          <span className="shrink-0 w-6 h-6 bg-slate-900 text-white rounded-full flex items-center justify-center text-sm">
                            1
                          </span>
