      ...
      <div className="w-full">
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Fasilitas Penunjang */}
            <div className="mb-16">
              <h2 className="text-2xl font-bold text-center mb-8 text-slate-900 tracking-tight">Fasilitas Penunjang</h2>
            ...
            <div className="bg-white rounded-lg p-8 border-2 border-slate-900 mb-16">
              <h2 className="text-2xl font-bold text-center mb-8 text-slate-900 tracking-tight">Teknologi dan Konektivitas</h2>
