...
const programs: Program[] = [
  {
    ...
    description: "Menjadi programmer profesional dengan menguasai berbagai bahasa pemrograman dan framework modern.",
  ...
  },
  {
    ...
    category: "TEKNIK KOMPUTER",
    description: "Ahli dalam merancang, mengimplementasikan, dan mengelola infrastruktur jaringan komputer.",
  ...
  },
  {
    ...
    description: "Menguasai sistem akuntansi modern dan manajemen keuangan untuk berbagai jenis bisnis.",
  ...
  },
  {
    ...
    description: "Ciptakan karya visual yang menarik untuk berbagai media digital dan cetak dengan kreativitas tanpa batas.",
  ...
  },
  {
    ...
    category: "BISNIS & MANAJEMEN",
    description: "Menjadi profesional dalam administrasi perkantoran dengan kemampuan teknologi informasi terkini.",
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {programs.map((program) => (
            ...
            >
              ...
              <div className="p-6">
                <div className="academic-accent font-semibold text-sm mb-2">
                  {program.category}
                </div>
