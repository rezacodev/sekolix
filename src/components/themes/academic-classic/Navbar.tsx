      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link href="/" className="px-3 py-2 text-gray-700 hover:text-blue-900 hover:bg-gray-100 font-medium rounded-lg transition-all">
              Beranda
            </Link>
            ...
            <Link href="/gallery" className="px-3 py-2 text-gray-700 hover:text-blue-900 hover:bg-gray-100 font-medium rounded-lg transition-all">
              Galeri
            </Link>
            <Link href="/contact" className="px-3 py-2 text-gray-700 hover:text-blue-900 hover:bg-gray-100 font-medium rounded-lg transition-all">
              Kontak
            </Link>
            <Link href="/apply" className="px-3 py-2 text-white bg-blue-900 hover:bg-slate-900 font-semibold rounded-lg transition-colors">
              Penerimaan Siswa
            </Link>
