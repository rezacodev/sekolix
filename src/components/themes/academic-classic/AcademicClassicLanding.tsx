...
const sampleNews = [
  {
    ...
    excerpt:
      "Students presented groundbreaking projects ranging from renewable energy solutions to AI applications, demonstrating exceptional creativity and scientific knowledge.",
  ...
  },
  {
    ...
    excerpt:
      "Our basketball team secured the state championship title after an intense final match, bringing pride to our school community.",
  ...
  },
  {
    ...
    excerpt:
      "The newly inaugurated STEM laboratory features cutting-edge technology and equipment, providing students with hands-on learning opportunities.",
...
const sampleTimeline = [
  {
    ...
    title: "Foundation",
    description:
      "Excellence Academy was established with a vision to provide world-class education to aspiring students."
  },
  {
    id: "2",
    year: "1995",
    ...
    description:
      "Built new science laboratories and library facilities to accommodate growing student population."
  },
  {
    id: "3",
    year: "2000",
    ...
    description:
      "Received accreditation from international education bodies, becoming a globally recognized institution."
  },
  {
    id: "4",
    year: "2010",
    ...
    description:
      "Launched digital learning initiatives with smart classrooms and online learning platforms."
  },
  {
    id: "5",
    year: "2020",
    ...
    description:
      "Successfully transitioned to hybrid learning model, ensuring continuity of education during challenging times."
  },
  {
    id: "6",
    year: "2025",
    ...
    description:
      "Opened state-of-the-art innovation center focusing on AI, robotics, and sustainable technologies."
  }
];
