    ...
    <footer className="bg-white border-t border-slate-200">
      <div className="max-w-6xl mx-auto px-4 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
              ...
              <div className="flex gap-4">
                {socialMedia.facebook && (
                  <a
                    ...
                    className="w-10 h-10 border border-slate-300 flex items-center justify-center text-slate-600 hover:border-slate-900 hover:text-slate-900 transition-colors duration-300"
                  >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm uppercase tracking-wider text-slate-900 font-medium mb-6">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-slate-600">
                ...
                <a
                  href={`tel:${phone}`}
                  className="font-light hover:text-slate-900 transition-colors"
                >
                  {phone}
                </a>
              </li>
