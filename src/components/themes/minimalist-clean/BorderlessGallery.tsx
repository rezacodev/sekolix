...
export default function BorderlessGallery({
  images,
  title,
  viewAllLink = "/gallery"
}: BorderlessGalleryProps) {
  ...
  return (
    <section className="py-32 px-4 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="mb-20">
          <h2 className="text-5xl md:text-6xl font-light text-slate-900 mb-8">{title}</h2>
        ...
        >
          ...
          >
            ...
            <div className="mt-8 text-center">
              ...
              <h3 className="text-3xl font-light text-slate-900">{selectedImage.title}</h3>
            </div>
          </div>
        </div>
      )}
