...
export function Navbar() {
  ...
  return (
    <>
      {/* Progress Bar */}
      <div
        className="progress-bar fixed top-0 left-0 h-1 bg-linear-to-r from-cyan-500 via-purple-500 to-orange-500 z-50"
        style={{ width: "0%" }}
        id="progressBar"
      ></div>

      <nav
        className={`navbar-glass fixed w-full top-0 z-50 transition-all duration-300 ${isScrolled ? "shadow-lg" : ""}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-6">
              <Link
                href="/"
                className="text-gray-700 hover-primary font-semibold transition-colors"
              >
                Beranda
              </Link>
              ...
              <Link
                href="/apply"
                className="bg-emerald-500 text-white px-4 py-2 rounded-xl font-semibold transition hover:bg-emerald-600"
              >
                Penerimaan Siswa
              </Link>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden py-4 space-y-3 animate-fade-in">
              <Link
                href="/"
                className="block text-gray-700 hover-primary font-semibold py-2 transition-colors"
              >
                Beranda
              </Link>
              <Link
