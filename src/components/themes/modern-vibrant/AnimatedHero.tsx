          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <h1 className="text-6xl md:text-7xl font-black mb-6 leading-tight">
                {title || "Wujudkan"}{" "}
                <span className="text-white drop-shadow-lg">{subtitle || "Impianmu"}</span> Bersama
                Kami
              </h1>
              ...
              <p className="text-xl mb-8 text-white/90 leading-relaxed">
                {body ||
                  "Bergabunglah dengan sekolah kejuruan terbaik yang menghadirkan pembelajaran inovatif, fasilitas modern, dan koneksi industri untuk masa depan gemilang! 🌟"}
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                ...
                {videoUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="bg-white/20 backdrop-blur-lg text-white px-8 py-4 rounded-xl font-bold border-2 border-white/30 hover:bg-white hover:text-cyan-600 transition-all"
                  >
                    Virtual Tour 🎥
                  </a>
                )}
            ...
            <div className="relative hidden md:block">
              ...
              <div
                className="absolute bottom-4 left-4 bg-white rounded-2xl p-4 shadow-xl icon-float max-w-[140px]"
