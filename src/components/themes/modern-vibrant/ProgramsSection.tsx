  ...
  const programs = [
    {
      ...
      description:
        "Belajar coding, web development, mobile apps, dan software engineering",
    ...
    },
    {
      ...
      description:
        "Kuasai graphic design, UI/UX, branding, dan multimedia production",
    ...
    },
    {
      ...
      description:
        "Ahli dalam networking, sistem administrasi, dan cyber security",
    ...
    },
    {
      ...
      description:
        "E-commerce, digital marketing, dan entrepreneurship modern",
    ...
    },
    {
      ...
      title: "Multimedia",
      description:
        "Video editing, fotografi, animasi, dan content creation",
    ...
    },
    {
      ...
      description:
        "Administrasi, komunikasi bisnis, dan office management",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Berbagai program keahlian dengan kurikulum terkini dan fasilitas
            lengkap untuk mengembangkan potensi terbaikmu
          </p>
        </div>
          ...
          <div className="bg-linear-to-r from-cyan-500 via-purple-500 to-orange-500 rounded-3xl p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
                Konsultasikan dengan tim kami untuk mendapatkan rekomendasi
