...
export function ApplicationAccessDropdown() {
  ...
  return (
    ...
    >
      <button className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-cyan-500 to-purple-500 text-white font-medium rounded-lg hover:shadow-lg transition-all">
        Akses Aplikasi
          ...
          <div className="grid grid-cols-2 gap-1 p-3">
            {applications.map(app => (
              <Link
                key={app.name}
                href={app.href}
                className="flex flex-col items-center justify-center gap-2 p-3 rounded-lg hover:bg-linear-to-br hover:from-cyan-50 hover:to-purple-50 transition-colors border border-gray-100 hover:border-cyan-300"
              >
