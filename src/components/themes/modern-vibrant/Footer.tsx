        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/" className="text-slate-400 hover:text-white transition-colors">Profil</Link></li>
              <li><Link href="/informasi/news" className="text-slate-400 hover:text-white transition-colors">Berita</Link></li>
              <li><Link href="/informasi/articles" className="text-slate-400 hover:text-white transition-colors">Artikel</Link></li>
              <li><Link href="/informasi/events" className="text-slate-400 hover:text-white transition-colors">Agenda</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Teknik Mekatronika</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Teknik Informatika</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Teknik Elektro</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Teknik Otomotif</a></li>
            </ul>
          </div>
