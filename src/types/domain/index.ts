...
export type { Gallery, GalleryAlbum, CreateGalleryInput, UpdateGalleryInput } from './gallery.types';
...
export type { Post, PostType, Article, News, Event, CreatePostInput, UpdatePostInput } from './post.types';
export type { Applicant, ApplicantStatus, CreateApplicantInput, UpdateApplicantInput, SPMBProgram } from './spmb.types';
export type { LandingSection, CreateLandingSectionInput, UpdateLandingSectionInput } from './landing-section.types';
